...
const questions = {
  ...
  Fun: "What the craziest thing you've ever done? What is your favourite memory?",
  Contact:
        ...
        <div className="w-full">
          ...
          >
            <button
              ...
              className="flex items-center gap-1 px-3 py-1 text-xs text-gray-600 transition-colors hover:text-gray-800 rounded-full hover:bg-white/10 backdrop-blur-sm"
            >
              {isVisible ? (
                <>
                  <ChevronDown size={14} />
              ...
              >
                {questionConfig.map(({ key, color, icon: Icon }) => (
                  <Button
                    ...
                    variant="outline"
                    className="border-white/20 hover:bg-white/20 h-auto min-w-[100px] flex-shrink-0 cursor-pointer rounded-xl border bg-white/10 px-4 py-3 shadow-lg backdrop-blur-md transition-all duration-200 active:scale-95 hover:shadow-xl"
                  >
                  ...
                  <Tooltip delayDuration={0}>
                    <TooltipTrigger asChild>
                      <Drawer.Trigger className="group relative flex flex-shrink-0 items-center justify-center">
                        <motion.div
                          className="hover:bg-white/20 flex h-auto cursor-pointer items-center space-x-1 rounded-xl border border-white/20 bg-white/10 px-4 py-3 text-sm backdrop-blur-md transition-all duration-200 shadow-lg hover:shadow-xl"
                          whileHover={{ scale: 1 }}
                          whileTap={{ scale: 0.98 }}
                        >
                          <div className="flex items-center gap-3 text-gray-800">
